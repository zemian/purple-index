...
$dir_stats = isset($_GET['dir_stats']);
$list_path = ($browse_dir === '') ? $root_path : "$root_path/$browse_dir";
$error = validate_path($list_path, $browse_dir);
...
<head>
    ...
    <style>
        ...
        .progress.is-extra-small {
            ...
            color: inherit;
            background-color: hsl(294, 71%, 79%);
            background-image: linear-gradient(to right, hsl(294, 71%, 79%) 30%, #ededed 30%);
        }
    </style>
</head>
<body>
    ...
    <?php } else { ?>
        ...
        <?php if ($dir_stats) { ?>
            <div id='dir-stats'>
                ...
                <progress id="dir-stats-progress" class="progress is-extra-small" max="100"></progress>
                <div class="level">
                    <div class="level-item">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            fetch(url).then(resp => resp.json()).then(data => {
                document.getElementById('dir-stats-progress').style.visibility = 'hidden';
                if (!data.error_message) {
                    ...
                    document.getElementById('dir-stats-error').style.visibility = 'visible';
                }
            });
        });
    </script>
